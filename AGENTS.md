...
### Tests
```bash
npx jest --ci         # 917 tests, 80 suites
npm test              # watch mode
...
npm run i18n:check     # parité des langues secondaires (clés vides/manquantes, interpolations) — exit 1 si défaut
```
Toute chaîne user-facing passe par `t()` — règles complètes : `.clinerules/rules.md` §23.
Workflow opérationnel (ajouter des chaînes / parfums / une langue, glossaire, pièges) : `docs/i18n-runbook.md`.
...
Runbook i18n (traductions) : `docs/i18n-runbook.md`
